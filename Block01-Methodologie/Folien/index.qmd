...
In der Forschung zu MiBiD spielen Trendstudien und Large-Scale-Assessments ebenfalls eine zentrale Rolle - etwa ESS (European Social Survey) oder PISA (Programme for International Student Assessment).

Sie liefern regelmäßig scheinbar präzise Diagnosen gesellschaftlicher Zustände: Wie "integrationserfolgreich" sind bestimmte Gruppen? Wie groß sind Bilungsdisparitäten? Wie verändert sich das Vertrauen in demokratische Institutionen?

* scheinbare Präzision jedoch trügerisch
* Stichproben ermöglichen zwar hohe externe Validität, analytisch aber begrenzt
* keine Aussagen über individuelle Entwicklungen möglich
* Ergebnisse werrden oft in politische und öffentliche Debatte eingespeist, als hätten sie erklären oder kausalen Charakter


* Pandelstudien wie SOEP (sozio-ökonomisches Pandel) oder NEPS (Nationales Bildungspanel) bieten hier wichtige Korrektive
* verfolgen dieselben Personen über längere Zeiträume
* erlauben differenzierte Einblicke in Bildungsbiografien, Integrationsprozesse und Einstellungswandel
* natürlich auch nicht frei von methodischen und konzeptionellen Problemen (Panelmortalität, eingeschränkte Messbarkeit koomplexer Konstrukte, ...)

:::

## Panelstudien als "Korrektive"? {.smaller .scrollable}

::: {.fragment}
[**Sozio-oekonomisches Panel (SOEP)**]{.imp}

Das SOEP ist eine seit 1984 jährlich durchgeführte repräsentative Panelstudie von Haushalten in Deutschland. Dabei werden dieselben Personen über viele Jahre hinweg wiederholt befragt. Erhoben werden unter anderem Daten zu Einkommen, Bildung, Erwerbsverläufen, Gesundheit sowie politischen Einstellungen und gesellschaftlicher Teilhabe. Durch gezielte Zusatzstichproben werden auch Migrant*innen und Geflüchtete differenziert erfasst. Das SOEP ermöglicht damit Analysen von sozialen Ungleichheiten und Lebensverläufen im Zeitverlauf.

:::

::: {.fragment}

[**Nationales Bildungspanel (NEPS)**]{.imp}

Das NEPS ist eine groß angelegte Längsschnittstudie zu Bildungsprozessen über den gesamten Lebensverlauf. Seit 2009 werden mehrere Kohorten – von der frühen Kindheit bis ins Erwachsenenalter – wiederholt untersucht. Im Fokus stehen der Erwerb von Kompetenzen, Bildungsentscheidungen und Bildungsrenditen, jeweils im Zusammenspiel mit sozialen und familiären Kontexten. Migration wird differenziert erfasst (z. B. Herkunft, Sprache, Bildungsstatus der Eltern), sodass sich insbesondere Bildungsungleichheiten und Bildungsbiografien im Kontext von Migration analysieren lassen.

:::

::: notes

SOEP- und NEPS-Daten zeigen übereinstimmend, dass **Unterschiede im Bildungserfolg und in der gesellschaftlichen Teilhabe** von Menschen mit Migrationserfahrung **weniger auf „Migration an sich“** zurückzuführen sind, sondern **auf sozial ungleiche Ausgangsbedingungen**, sprachliche Ressourcen, institutionelle Strukturen und Diskriminierungserfahrungen. Diese Prozesse werden in Paneldaten als **langfristige, sich _verstärkende_ Bildungs- und Integrationsverläufe** sichtbar.

:::

## Übung 2 {.smaller .scrollable}
#### Indikatoren werden leicht missverstanden

Auch im Feld der Biodiversität spielen Trendstudien und Large-Scale-Assessments eine zentrale Rolle – etwa der Living Planet Index (LPI) oder der National Ecosystem Assessment (NEA). Sie liefern regelmäßig scheinbar klare Diagnosen über den Zustand von Ökosystemen: Wie stark geht die Biodiversität zurück? Welche Arten sind besonders betroffen? Wie entwickelt sich das Umweltbewusstsein in der Bevölkerung?

Doch auch hier ist Vorsicht geboten. Die aggregierten Kennzahlen und Indizes vermitteln den Eindruck hoher Präzision und Vergleichbarkeit, basieren jedoch häufig auf stark verdichteten und selektiven Daten. Zwar ermöglichen große Datensammlungen eine hohe externe Validität im Sinne globaler oder nationaler Trends, gleichzeitig bleiben die zugrunde liegenden ökologischen Prozesse oft unterbestimmt. Was als „Biodiversitätsverlust“ quantifiziert wird, ist in vielen Fällen das Ergebnis spezifischer Messentscheidungen – etwa welche Arten berücksichtigt werden, in welchen Regionen Daten vorliegen und wie Veränderungen gewichtet werden.

Hinzu kommt, dass viele dieser Studien als wiederholte Querschnittserhebungen angelegt sind. Sie zeigen Trends, aber nur begrenzt Prozesse. Koinzidenzen – etwa zwischen Landnutzungsänderungen, Klimafaktoren und Artenrückgang – werden nicht selten als implizite Ursache-Wirkungs-Zusammenhänge gelesen, obwohl die interne Validität solcher Schlüsse begrenzt ist. In der öffentlichen Kommunikation verdichten sich diese Befunde dann oft zu scheinbar eindeutigen Krisendiagnosen, die wissenschaftlich so nicht ohne Weiteres gedeckt sind.

::: {.fragment}
#### Übung
[{{< fa book-open >}}]{.imp} Bitte lesen Sie den Presseartikel auf  [https://ogy.de/mvl-004 {{< fa square-up-right >}}](https://ogy.de/mvl-004) und bewerten Sie die interne Validität der Schlussfolgerung.<br><br>
:::
...
* Skalenwechsel: Population → Art
* Bedeutungsverschiebung: Rückgang → Aussterben
* Aggregationseffekt: Durchschnitt → dramatische Einzelfallinterpretatio

Der Living Planet Index misst durchschnittliche Veränderungen von Populationsgrößen ausgewählter Wirbeltierarten. Aussagen über das Ausmaß des Artensterbens lassen sich daraus nicht direkt ableiten, sondern höchstens indirekt und unter zusätzlichen Annahmen über den Zusammenhang zwischen Populationsrückgang und Extinktionsrisiko.


+ + +

Längsschnittlich angelegte Monitoringprogramme und Paneldesigns – etwa wiederholte Biodiversitätserhebungen in denselben Habitaten – bieten hier wichtige Ergänzungen. Sie ermöglichen es, Veränderungen konkreter Populationen und Ökosysteme über die Zeit hinweg differenzierter zu analysieren und ökologische Dynamiken besser zu verstehen. Dennoch bleiben auch diese Ansätze abhängig von methodischen Entscheidungen, etwa zur Stichprobenauswahl, Taxonomie oder Erhebungsfrequenz.


**Europaweite Trendstudien**
European Red List
→ Bewertet Gefährdungsstatus von Arten
→ Wiederholte Updates ermöglichen Trendanalysen
Pan-European Common Bird Monitoring Scheme
→ Einer der robustesten Biodiversitätsindikatoren in Europa
→ Zeigt langfristige Trends häufiger Vogelarten (z. B. Agrarlandarten)


**Deutschland**
Rote Liste gefährdeter Arten Deutschlands
→ Klassischer Referenzrahmen für Biodiversitätszustand
→ In Abständen aktualisiert → Trendbeobachtung
Monitoring häufiger Brutvögel
→ Langfristige Daten zu Vogelpopulationen
→ Oft zitiert (z. B. Rückgang von Feldvögeln)
Insektenmonitoring Deutschland
→ Verschiedene Programme (u. a. nach der „Krefelder Studie“)
→ Politisch stark wirksam im Kontext „Insektensterben“
...
## <!--Exkurs: Präregistrierung--> {.center}
![](img/preregistered_large_color.png){style="display:block; margin:auto;" width="15%"}
[Exkurs: Präregistrierung]{.imp style="font-size:1.8em"}

## Exkurs: Präregistrierung {.smaller}

**Ausgangspunkt**

* Replikationskrise (insb. psychologische Forschung)
* Kritik: 
    * p-Hacking
    * HARKing
...
## Zwölf p-Hacking Strategien... {.smaller}

... die es zu verhindern gilt [@stefan2023]:


::: {.incremental}
(@) Selective reporting of dependent variable
(@) Selective reporting of independent variable
(@) Optional stopping
(@) Outlier exclusion
...
(@) Favourable imputation
(@) Subgroup analyses
(@) Incorrect rounding
:::

## Zwölf p-Hacking Strategien...  {.smaller .scrollable}

... und deren Folgen [nach @stefan2023]:

![](img/stefanschoenbrodt2023figure13.png){width="50%" style="display:block; margin:auto;"}

Two scenarios for p-hacking ‘workflows’ and their effect on false-positive rates. (a) p-hacking workflow in a t-test. (b) p-hacking workflow in a regression analysis. p-hacking strategies are applied sequentially; at each stage, incorrect rounding with a rounding level of p < 0.051 is applied in addition. The solid grey line shows the nominal α-level of 5%.
    

## p-Hacking Prävention {.smaller}

Eine vorgeschlagene Lösung: **Präregistrierung**

> Die Präregistrierung (»preregistration«) einer Studie meint eine öffentliche Beschreibung eines Studienvorhabens _vor_ seiner Durchführung. Dies umfasst bei konfirmatorischen Studien die Beschreibung von Hypothesen bis hin zu Erhebungs- und Analyseplänen. Es existieren unterschiedliche Präregistrierungsformulare, die je nach Studientyp verschiedene Detailangaben verlangen. Präregistrierungen werden mit Präregistrierungsdatum (Zeitstempel) veröffentlicht und können im Nachhinein nicht mehr verändert werden. Weicht die spätere Datenanalyse vom präregistrierten Analyseplan ab, so ist dies begründungspflichtig. Ein führender internationaler und disziplinenübergreifender Präregistrierungsserver ist der Server der [Open-Science-Foundation OSF](osf.io). [vgl. @doering2023]

. . .

::: {.callout-tip icon=false collapse="false"}
## {{< fa book-open >}} Weiterführende Literatur
Nosek, B. A., Ebersole, C. R., DeHaven, A. C., & Mellor, D. T. (2018). The preregistration revolution. _Proceedings of the National Academy of Sciences_, _115_(11), 2600–2606. [https://doi.org/10.1073/pnas.1708274114](https://doi.org/10.1073/pnas.1708274114)

Hardwicke, T. E., & Wagenmakers, E.-J. (2023). Reducing bias, increasing transparency and calibrating confidence with preregistration. _Nature Human Behaviour_, _7_(1), 15–26. [https://doi.org/10.1038/s41562-022-01497-2](https://doi.org/10.1038/s41562-022-01497-2)
:::
...
> Führt »fest daran glauben« zu verbesserten Ergebnissen?
...
Positive Testing (Klayman & Ha, 1987)
Tendenz, Hypothesen bevorzugt durch Fälle zu testen, die die Hypothese bestätigen könnten, statt durch besonders informative, potenziell widersprechende Fälle. Dadurch wird oft weniger effektiv geprüft als möglich.

Regression zur Mitte (Barnett, van der Pols & Dobson, 2005)
Statistisches Phänomen, bei dem extreme Messwerte bei einer erneuten Messung tendenziell näher am Durchschnitt liegen – unabhängig von echten Veränderungen. Wird häufig fälschlich als kausaler Effekt interpretiert.

Erwartungseffekte (Rosenthal & Fode, 1963)
Veränderungen im Verhalten oder in Ergebnissen, die dadurch entstehen, dass Erwartungen von Forschenden oder Lehrenden (bewusst oder unbewusst) das Verhalten von Versuchspersonen oder Schülern beeinflussen (auch „Experimenter Bias“ / „Pygmalion-Effekt“ im weiteren Sinne).

Confirmation Bias (Nickerson, 1998)
Systematische Neigung, Informationen so zu suchen, zu interpretieren und zu erinnern, dass sie bestehende Überzeugungen bestätigen, während widersprüchliche Informationen ignoriert oder abgewertet werden.

Anchor Bias (Lieder, Griffiths, Huys & Goodman, 2018)
Urteilsverzerrung, bei der eine anfängliche Zahl oder Information („Anker“) die nachfolgenden Schätzungen oder Entscheidungen unverhältnismäßig stark beeinflusst, selbst wenn der Anker irrelevant oder zufällig ist.


:::


## Übung 3 {.smaller .scrollable}

:::: {.columns}

::: {.column width='50%'}

![](img/klebletal2023.png){width="100%"}
:::

::: {.column width='50%'}

Screenen Sie die Studie von Klebel et al. [-@klebel2025].



Klassifizieren Sie die Studie als...
