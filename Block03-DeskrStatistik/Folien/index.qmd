...
|---------------------------------------:|:-------------------------------|
| [{{< iconify fa6-solid:pencil >}}]{.imp } | Grafische Darstellungen |
| [{{< iconify fa6-solid:lightbulb >}}]{.imp}  | Informationsgehalt von Effektstärken |
| [{{< iconify fa6-solid:ruler >}}]{.imp} | Effektstärken für Gruppenunterschiede (Cohen's $U_1$, Cohen's $d$ und Hedge's $g$) |
...
plot1 <-
  ...
  theme(panel.grid.major = element_blank(),
        ...
        plot.subtitle = element_text(color = "white", size = 12, hjust = 0)
  )
...
::: {.incremental}
* $d(XY) = \frac{\bar{x}-\bar{y}}{\sqrt{\frac{(n_1-1)s_x^2 + (n_2-1)s_y^2}{n_1+n_2-2}}}$
...
## [Hedge's $g$]{style="font-size:.8em;"}{.center .smaller}

::: {.incremental}
* $g = J⋅d$
* $J=1-\frac{3}{4(n_1+n_2)-9}$
* nahezu identisch zu Cohen's $d$, aber korrigiert für kleine Stichproben
* kommt i.d.R. bei Meta-Analysen und bei $n_1≠n_2$ zum Einsatz
...
min_plot <- 
  ggplot(min_data |> 
         ...
         aes(`Höchster Abschluss der Eltern`, 
             `Höchster Abschluss\ndes Befragten`)) +
  geom_jitter(color = "#267326", width = .2, height = .2) +
  #theme_modern_rc() +
  theme_ipsum_rc() +
  theme(strip.text = element_text(color = "black"))
...
$\tau_{\mathrm{b}} \left(X,Y \right)=\frac{\color{#8cd000}{n_{\mathrm{K}}}-\color{#d77d00}{n_{\mathrm{D}}}}{\sqrt{\left(\color{#8cd000}{n_{\mathrm{K}}}+\color{#d77d00}{n_{\mathrm{D}}}+\color{purple}{n_{\mathrm{B}(X)}}\right) \cdot\left(\color{#8cd000}{n_{\mathrm{K}}}+\color{#d77d00}{n_{\mathrm{D}}}+\color{#0FA5D7}{n_{\mathrm{B}(Y)}}\right)}} = \frac{\color{#8cd000}{10} - \color{#d77d00}{1}}{\sqrt{\left(\color{#8cd000}{10} + \color{#d77d00}{1} +\color{purple}{2} \right) \cdot \left( \color{#8cd000}{10} + \color{#d77d00}{1} +\color{#0FA5D7}{2} \right)}} \approx .69$
