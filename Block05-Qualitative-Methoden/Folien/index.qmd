...
## <!--Arten von qualitativen Interviews--> {.smaller .scrollable}
...
* **Leitfadeninterview:** Mitarbeitende werden anhand eines Leitfadens zu ihren Erfahrungen mit KI befragt.
* **Experteninterview:** IT-Leitung oder Digitalisierungsbeauftragte werden zu Einführung, Strategie und Umsetzung der KI befragt.
* **Problemzentriertes Interview:** Mitarbeitende berichten ausführlich über Herausforderungen und Belastungen durch die KI-Einführung.
* **Fokussiertes Interview:** Mitarbeitende werden direkt nach einer KI-Schulung oder nach dem Test einer neuen KI-Anwendung zu ihren Eindrücken befragt.
